...
ThisBuild / crossScalaVersions := Seq("2.13.17", (ThisBuild / scalaVersion).value)
...
lazy val scalaPhoneNumber =
  crossProject(JVMPlatform, JSPlatform)
    ...
    .jvmSettings(libraryDependencies += "com.googlecode.libphonenumber" % "libphonenumber" % "9.0.17")
