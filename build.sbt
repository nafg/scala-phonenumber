...
ThisBuild / crossScalaVersions := Seq("2.13.12", (ThisBuild / scalaVersion).value)
...
lazy val scalaPhoneNumber =
  crossProject(JVMPlatform, JSPlatform).crossType(CrossType.Full)
    ...
    .jvmSettings(libraryDependencies += "com.googlecode.libphonenumber" % "libphonenumber" % "8.13.20")
