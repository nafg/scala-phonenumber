...
object LibphonenumberJs extends js.Object {
  ...
  def parsePhoneNumberWithError(number: String, defaultCountry: js.UndefOr[String] = js.undefined): PhoneNumber =
    js.native
  def parsePhoneNumberFromString(
    number: String,
    defaultCountry: js.UndefOr[String] = js.undefined
  ): js.UndefOr[PhoneNumber] = js.native

  def isPossiblePhoneNumber(text: String, defaultCountry: js.UndefOr[String] = js.undefined): Boolean = js.native
}
